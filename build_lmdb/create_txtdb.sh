...
#                 --output /data7/emobert/txt_db/movies_v2_th0.1_all_2000.db \
#                 --filter_path /data7/emobert/img_db_nomask/movies_v2/nbb_th0.1_max100_min10.json \
...
python mk_txtdb_by_faces.py --input /data7/emobert/data_nomask/movies_v2/ref_captions.json \
                --output /data7/emobert/txt_db/movies_v2_th0.1_all_trn.db \
                --filter_path /data7/emobert/img_db_nomask/movies_v2/nbb_th0.1_max100_min10.json \
                --filter_path_val /data7/emobert/txt_db/movies_v2_th0.1_all_2000.db/img2txts.json \
