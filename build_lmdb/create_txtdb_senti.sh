...
# step1
python mk_txtdb_by_faces_sentiword.py --input /data7/emobert/data_nomask_new/voxceleb2_v1/ref_captions.json \
                --output /data7/emobert/txt_db/voxceleb2_v1_th1.0_emowords_sentiword_all.db \
...
python mk_txtdb_by_faces_sentiword.py --input /data7/emobert/data_nomask_new/voxceleb2_v1/ref_captions.json \
                --output /data7/emobert/txt_db/voxceleb2_v1_th1.0_emowords_sentiword_all_val3k.db \
                --filter_path /data7/emobert/img_db_nomask/voxceleb2_v1/fc/nbb_th1.0_max64_min10.json \
...
python mk_txtdb_by_faces_sentiword.py --input /data7/emobert/data_nomask_new/voxceleb2_v1/ref_captions.json \
                --output /data7/emobert/txt_db/voxceleb2_v1_th1.0_emowords_sentiword_all_trn.db \
                --filter_path /data7/emobert/img_db_nomask/voxceleb2_v1/fc/nbb_th1.0_max64_min10.json \
                --filter_path_val /data7/emobert/txt_db/voxceleb2_v1_th1.0_emowords_sentiword_all_val3k.db/img2txts.json \
...
python mk_txtdb_by_faces_sentiword.py --input /data7/emobert/data_nomask_new/voxceleb2_v1/ref_captions.json \
                --output /data7/emobert/txt_db/voxceleb2_v1_th1.0_emowords_sentiword_all_trn3k.db \
                --filter_path /data7/emobert/img_db_nomask/voxceleb2_v1/fc/nbb_th1.0_max64_min10.json \
                --include_path /data7/emobert/txt_db/voxceleb2_v1_th1.0_emowords_sentiword_all_trn.db/img2txts.json \
