...
#                     --output /data7/emobert/exp/evaluation/IEMOCAP/txt_db/${i}/${setname}_wwm_nrcemolex_prompt_mask_iam.db \
...
#                     --output /data7/emobert/exp/evaluation/MSP/txt_db/${i}/${setname}_wwm_nrcemolex_prompt_mask_iam.db \
