...
from build_lmdb.mk_txtdb_by_faces_sentiword import get_emo_words, get_emo_type_ids
...
def process_jsonl(jsonf, db, toker, dataset_name="", filter_path=None, remove_low_quality_path=None, num_samples=0, use_emo=False):
    '''
    {
        "segmentId": [
