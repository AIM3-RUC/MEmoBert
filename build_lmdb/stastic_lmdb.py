...
if __name__ == '__main__':
    ...
    if True:
        ...
        for key in video2lens.keys():
            _len = video2lens[key]
            text_tokens_lens.append(_len)
        avg_len, min_len, m80_len = compute_stastic_info(text_tokens_lens)
        print('\t Tokens {} Avg {:.2f} Mid {:.2f} Mid80 {:.2f}'.format(len(text_tokens_lens), avg_len, min_len, m80_len) + '\n')