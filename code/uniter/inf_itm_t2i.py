...
run inference for Text2Image Retrieval
"""
import argparse
import json
import os
...
def evaluate(model, eval_loader):
    # need to modity for text2images retrival
    model.eval()
    st = time()
    LOGGER.info("start running Text2Image Retrieval evaluation ...")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--txt_db", default=None, type=str,
                        help="The input inference corpus. (LMDB)")
    parser.add_argument("--img_db", default=None, type=str,
                        help="The input all candidates images.")
