...
CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python pretrain.py \
        ...
        --num_train_steps 1000 --warmup_steps 100 --valid_steps 200 \
        --output_dir /data7/emobert/exp/task_pretrain/${corpus_name}_basedon-nomask_movies_v1v2_uniter_4tasks_faceth0.5_5k-4tasks_maxbb36_faceth0.5/${cvNo}
done
...
#         --output_dir /data7/emobert/exp/task_pretrain/${corpus_name}_basedon-nomask_movies_v1v2_uniter_4tasks_faceth0.5_mltmelm5_5k-4tasks_maxbb36_faceth0.5_mltmelm5/${cvNo}
# done