...
python convert_imgdir.py --img_dir $img_dir --output $output_dir --conf_th 0.5 --max_bb 36 --nproc 24
# python convert_imgdir.py --img_dir $img_dir --output $output_dir --conf_th 0.0 --max_bb 64 --nproc 24
echo "done"