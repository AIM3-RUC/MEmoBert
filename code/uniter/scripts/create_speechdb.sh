...
img_dir=/data7/emobert/wav2vec_feature_npzs/voxceleb2_v1_3mean
output_dir=/data7/emobert/wav2vec_db/voxceleb2_v1_3mean
...
python convert_imgdir.py --img_dir $img_dir --output $output_dir --conf_th 1.0 --max_bb 96 --nproc 16
echo "done"