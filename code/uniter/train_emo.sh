...
CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
        ...
        --train_batch_size 128 --train_batch_size 128 --num_train_steps 500 \
        --output_dir /data4/emobert/exp/evaluation/${corpus_name_big}/finetune/baseon-movies_v1v2_uniter_4tasks_step5k-lr2e5_bs128_max36
done
...
#         --output_dir /data4/emobert/exp/evaluation/${corpus_name_big}/finetune/baseon-movies_v1v2_uniter_2tasks_step5k-lr2e5_bs128_max64
# done
