...
do
    CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
            --cvNo ${i} --config config/train-emo-msp-openface-base-4gpu.json \
            --checkpoint /data7/emobert/exp/pretrain/nomask_movies_v1_uniter_mlm_mrfr_mrckl_3tasks/ckpt/model_step_100000.pt \
            --output_dir /data7/emobert/exp/finetune/msp_openface_baseon_nomask_movies_v1_uniter_mlm_mrfr_mrckl_3tasks \
