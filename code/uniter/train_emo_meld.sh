...
do
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
                ...
                --output_dir /data7/emobert/exp/evaluation/MELD/finetune/baseon-movies_v1v2v3_uniter_4tasks-lr${lr}_infbs32_th${conf_th}_train3000_trnval
        done
done
...
#                 --output_dir /data7/emobert/exp/evaluation/MELD/finetune/baseon-taskpretrain-movies_v1v2v3_uniter_4tasks_faceth0.5_step1000-lr${lr}_infbs32_faceth${conf_th}
#         done
# done
