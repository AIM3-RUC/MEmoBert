...
CUDA_VISIBLE_DEVICES=0 horovodrun -np 1 python pretrain.py \
        ...
        --train_batch_size 16 --val_batch_size 16 --gradient_accumulation_steps 4 \
        ...
        --output_dir /data7/emobert/exp/pretrain/flow3-text12_fix-wav2vec2_fix-cross4Update-nomask_movies_v1v2v3_uniter_mlmitm_lr5e5_notypeemb