...
#                 --train_batch_size ${train_batch_size} --inf_batch_size ${inf_batch_size} \
#                 --num_train_steps ${num_train_steps} --valid_steps ${valid_steps}  \
#                 --output_dir /data7/emobert/exp/evaluation/IEMOCAP/finetune/flow3_stage1_text12_fix-wav2vec2_fix-cross4Update_movies_v1v2v3-lr${lr}_th${conf_th}_train${num_train_steps}_trnval
#         done
# done    
