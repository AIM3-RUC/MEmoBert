...
do
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo_img.py \
                --cvNo 1 --model_config config/uniter-3flow_v4c4.json \
                --cls_num 7 --use_visual \
                ...
                --output_dir /data7/emobert/exp/evaluation/MELD/finetune/flow3_text12_visual4_cross4_typeEmb-movies_v1v2v3_uniter_lr5e5-backbone_scratch_optimFalse-lr${lr}_th${conf_th}_max36_train3000_trnval
        done    
done
