...
#                 --output_dir /data7/emobert/exp/evaluation/MSP/finetune/flow3-directTrain-text12-wav2vec2-lr${lr}_th${conf_th}_train${num_train_steps}_trnval
#         done
# done    
...
#                 --train_batch_size ${train_batch_size} --inf_batch_size ${inf_batch_size} \
#                 --num_train_steps ${num_train_steps} --valid_steps ${valid_steps}  \
#                 --output_dir /data7/emobert/exp/evaluation/MSP/finetune/flow3_stage1_text12_fix-wav2vec2_fix-cross4Update_movies_v1v2v3_train10w-lr${lr}_th${conf_th}_train${num_train_steps}_trnval
#         done
# done    
...
do
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
                ...
                --train_batch_size ${train_batch_size} --inf_batch_size ${inf_batch_size} \
                --num_train_steps ${num_train_steps} --valid_steps ${valid_steps}  \
                --output_dir /data7/emobert/exp/evaluation/MSP/finetune/flow3_stage12_text12Update-wav2vec2Update-cross4Update_movies_v1v2v3_train5w-lr${lr}_th${conf_th}_train${num_train_steps}_trnval
        done
done
