...
do
        ...
        do
                ...
                CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
                        ...
                        --output_dir /data7/emobert/exp/evaluation/MELD/finetune/flow3_text12_visual4_speech4_cross4_typeEmb-movies_v1v2v3_uniter_lr5e5-backbone_scratch_optimFalse-lr${lr}_th${conf_th}_train3000_${norm_type}_trnval
        done
done