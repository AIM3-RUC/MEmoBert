...
CUDA_VISIBLE_DEVICES=2 horovodrun -np 1 python pretrain.py \
        --cvNo 0 --config config/pretrain-movies-v1v2v3-base-2gpu_ImgcomparE_2optim_fom.json \
        --model_config config/uniter-3flow_s4v4c4.json \
        --pretrained_text_checkpoint /data7/emobert/resources/pretrained/bert_base_model.pt \
        --use_visual --use_speech \
        --train_batch_size 24 --val_batch_size 24 --gradient_accumulation_steps 8 \
        --learning_rate 5e-5 --lr_sched_type 'linear' \
        --max_txt_len 30 \
        --conf_th 0.5 --max_bb 36 --min_bb 10 \
        --speech_conf_th 1.0 --max_frames 360 --min_frames 10 \
        --num_train_steps 10000 --warmup_steps 1000 --valid_steps 100 \
        --output_dir /data7/emobert/exp/pretrain/flow3_text12_speech4_visual4_speech4_cross4_fom_debug

# for visual+text
# CUDA_VISIBLE_DEVICES=2 horovodrun -np 1 python pretrain.py \
#         --cvNo 0 --config config/pretrain-movies-v1v2v3-base-2gpu_ImgcomparE_2optim_mlmitm.json \
#         --model_config config/uniter-3flow_s4v4c4.json \
...
#         --conf_th 0.5 --max_bb 36 --min_bb 10 \
#         --speech_conf_th 1.0 --max_frames 360 --min_frames 10 \
#         --num_train_steps 10000 --warmup_steps 1000 --valid_steps 500 \
#         --output_dir /data7/emobert/exp/pretrain/flow3_text12_visual4_cross4_typeEmb-nomask_movies_v1v2v3_uniter_mlmitm_lr5e5-textbackbone_optimFalse-bs480_faceth0.5_debug
...
#         --pretrained_text_checkpoint /data7/MEmoBert/emobert/resources/pretrained/bert_base_model.pt \
#         --use_speech \
#         --train_batch_size 64 --val_batch_size 64 --gradient_accumulation_steps 8 \
#         --learning_rate 5e-5 --lr_sched_type 'linear' \
#         --max_txt_len 30 \
#         --conf_th 0.5 --max_bb 36 --min_bb 10 \
#         --speech_conf_th 1.0 --max_frames 360 --min_frames 10 \
