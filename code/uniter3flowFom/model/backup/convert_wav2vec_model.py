...
https://github.com/huggingface/transformers/blob/1c06240e1b3477728129bb58e7b6c7734bb5074e/src/transformers/models/wav2vec2/convert_wav2vec2_original_pytorch_checkpoint_to_pytorch.py
"""
...
if __name__ == "__main__":
    ...
    # transfer checkpoint to folder
    # python convert_wav2vec_model.py --pytorch_dump_folder_path /data7/emobert/resources/pretrained/wav2vec_base --checkpoint_path /data7/emobert/resources/pretrained/wav2vec_base/checkpoint.pt