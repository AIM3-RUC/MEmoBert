...
do
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
                --cls_num 7 \
                --cvNo 1 --model_config config/uniter-3flow_v2c2.json \
                ...
                --output_dir /data7/emobert/exp/evaluation/MELD/finetune/resnet3d_baseon-movies_v1v2v3_uniter_lr5e5-backbone_scratch_optimFalse_continue1w-lr${lr}_infbs1_th${conf_th}_max36_train3000
        done    
done
