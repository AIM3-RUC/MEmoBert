...
do
    ...
    do
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python extract_fts.py \
            ...
            --output_dir /data7/emobert/exp/uniter3m_fts/${corpus_name_small}/nomask_movies_v1v2v3_uniter3m_speechwav2vec_5taskswwm_mrm_msrm_maskprobv.3s.3_noitm_lr5e5_bs800_nofinetune_onlyV/${cvNo}/${setname} \
            --fp16 --batch_size 100 --use_visual
    done
done