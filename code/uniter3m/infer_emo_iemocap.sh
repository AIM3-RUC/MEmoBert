...
do
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python infer_emo.py \
                ...
                --checkpoint ${checkpoint_dir}/nomask-movies_v1v2v3_uniter3m_visual_wav2vec_text_5tasks-lr5e-5_train1200_trnval/drop0.1_frozen0_vqa_none/${cvNo}/ckpt/ \
                ...
                --output_dir /data7/emobert/exp/evaluation/${corpus_name_L}/inference/nomask-movies_v1v2v3_uniter3m_visual_wav2vec_text_5tasks_valAVL
done