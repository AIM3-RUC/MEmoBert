...
# 由于没有语音相关的情感任务，所以暂时只考虑视觉和文本两个模态进行验证

# ### case1: Only Emocls, based on nomask_moviesv1v2v3_vox2_v1_uniter3m_visual_text_4tasks_lr5e5_bs800_faceth0.5 做一些 abaltion study.
...
#         --checkpoint /data7/emobert/exp/pretrain/nomask_moviesv1v2v3_vox2_v1_uniter3m_visual_text_4tasks_lr3e5_bs800_faceth0.5/ckpt/model_step_40000.pt \
