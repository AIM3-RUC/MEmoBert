...
#         --config config/pretrain-movies-v1v2v3-base-2gpu_visual_text_wav2vec_5tasks_indemocls_p1p2_emo5.json \
#         --model_config config/uniter-base-emoword_nomultitask_difftype_weaklabelSoft.json \
#         --learning_rate 5e-05 --lr_sched_type 'linear' --gradient_accumulation_steps 4 \
#         --IMG_DIM 342 --Speech_DIM 768 \
#         --train_batch_size 100 --val_batch_size 100 \
#         --num_train_steps 40000 --warmup_steps 4000 --valid_steps 8000 \
#         --output_dir /data7/emobert/exp/pretrain/nomask_movies_v1v2v3_uniter3m_visual_text_wav2vec_5tasks_indemocls_p1p2_emo5_lr5e5_bs512