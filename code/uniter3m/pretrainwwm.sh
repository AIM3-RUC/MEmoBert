...
CUDA_VISIBLE_DEVICES=0 horovodrun -np 1 python pretrain.py \
        ...
        --num_train_steps 30000 --warmup_steps 3000 --valid_steps 50 \
        --output_dir /data7/emobert/exp/pretrain/nomask_movies_v1v2v3_uniter3m_visual_text_4tasks_wwm_lr5e5_bs512_debug