...
do
    ...
    do
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
                ...
                --output_dir /data7/emobert/exp/evaluation/MSP/finetune/nomask-movies_v1v2v3_uniter3m_visual_wav2vec_text_5tasks_emoclslare0.0_withitm_vstype2_train3w-lr${lr}_${clstype}_train${num_train_steps}_trnval_pos
        done
    done
done
...
#                 --train_batch_size ${train_batch_size} --inf_batch_size ${inf_batch_size} \
#                 --num_train_steps ${num_train_steps} --valid_steps ${valid_steps}  \
#                 --output_dir /data7/emobert/exp/evaluation/MSP/finetune/nomask-movies_v1v2v3_uniter3m_visual_wav2vec_text_emoclslare1.0_withitm_vstype2_train3w-lr${lr}_${clstype}_train${num_train_steps}_trnval_pos
#         done
#     done
# done
