...
do
    ...
    do
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
                ...
                --train_batch_size ${train_batch_size} --inf_batch_size ${inf_batch_size} \
                --num_train_steps ${num_train_steps} --valid_steps ${valid_steps}  \
                --output_dir /data7/emobert/exp/evaluation/${corpus_name_L}/finetune/nomask-movies-v1v2v3-base-uniter3m_speechwav2vec_5tasks_wwm_mrm_msrm_maskprobv.5s.5_noitm_train4w-new-lr${lr}_train${num_train_steps}_trnval_part${partration}_seed${seed}
        done
    done
done
...
# case2: all seven cases mrm_msrm_maskprobv.3s.3
# for lr in 3e-5
# do
#     for seed in 42 1234 4321 5678 
#     do
...
#                         --train_batch_size 32 --val_batch_size 32 \
#                         --num_train_steps 4000 --warmup_steps 100 --valid_steps 100 \
#                         --output_dir /data7/emobert/exp/prompt_pretrain/${corpus_name}_basedon-movies_v1v2v3_uniter3m_visual_wav2vec_text_5tasks_wwm_mrm_msrm_maskprobv.3s.3_step4w-cm_mask_prompt_icassp_lr${lr}_trnval_seed${seed}/${cvNo}
#         done
#     done
# done

# case3: all seven cases mrm_msrm_maskprobv.5s.5
# for lr in 3e-5
# do
#     for seed in 42 1234 4321 5678
#     do
...
#                         --train_batch_size 32 --val_batch_size 32 \
#                         --num_train_steps 4000 --warmup_steps 100 --valid_steps 100 \
#                         --output_dir /data7/emobert/exp/prompt_pretrain/${corpus_name}_basedon-movies_v1v2v3_uniter3m_visual_wav2vec_text_5tasks_wwm_mrm_msrm_maskprobv.5s.5_step4w-cm_mask_prompt_icassp_lr${lr}_trnval_seed${seed}/${cvNo}
#         done
#     done
# done