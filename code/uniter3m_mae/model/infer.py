...
from code.uniter3m_mae.model.model import UniterModel, UniterPreTrainedModel
from code.uniter3m_mae.utils.misc import NoOp
...
class UniterForExtracting(UniterPreTrainedModel):
    ...
    def forward(self, batch):
        ...
        return cls_output, txt_sequence_output, txt_lens, img_sequence_output, img_lens, speech_sequence_output, speech_lens
...
def extracting(model, loader):
    ...
    for i, batch in enumerate(loader):
        ...
        cls_features, txt_sequence_output, txt_lens, img_sequence_output, img_lens, speech_sequence_output, speech_lens = model(batch)
        for j in range(len(batch_targets)):
            ...
            cls_outputs.append(cls_features[j].cpu().numpy())
    ...
    return cls_outputs, txt_real_sequence_outputs, img_real_sequence_outputs, speech_real_sequence_outputs, targets