...
from code.uniter3m_mae.data import (TokenBucketSampler, TokenBucketSamplerForItm,
...
from code.uniter3m_mae.model.pretrain import UniterForPretraining
from code.uniter3m_mae.optim.misc import build_optimizer
from code.uniter3m_mae.model.emocls import evaluation_metric
...
if __name__ == "__main__":
    ...
    # use mae decoder
    parser.add_argument("--use_mae", action='store_true',  help='use mae_decoder')
