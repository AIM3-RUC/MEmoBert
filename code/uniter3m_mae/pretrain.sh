...
CUDA_VISIBLE_DEVICES=0,1,2,4 horovodrun -np 4 python pretrain.py \
        ...
        --config config/mae/pretrain-movies-v1v2v3-base-2gpu_speechwav2vec_5tasks_wwm_span_noitm.json \
        --model_config config/mae/uniter-base-emoword_nomultitask_difftype_weaklabelSoft.json \
        --learning_rate 5e-05 --lr_sched_type 'linear' --gradient_accumulation_steps 4 \
        --IMG_DIM 342 --Speech_DIM 768 \
        --max_txt_len 50 --use_mae \
        --train_batch_size 200 --val_batch_size 200 \
        --num_train_steps 30000 --warmup_steps 3000 --valid_steps 5000 \
        --output_dir /root/lrc/MEmoBert/result/pretrain/nomask_movies_v1v2v3_uniter3m_MAE_speech_text_3tasks_noitm_lr5e5_bs800
