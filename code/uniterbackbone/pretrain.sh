...
# 2. conv3dresnet-pretrained-twoOptim-th0.5 --running
...
#         --output_dir /data7/emobert/exp/pretrain/resnet3d_nomask_movies_v1v2v3_uniter_mlmitm_lr5e5-backbone_pretrained_optimFalse-bs480_faceth0.5 
...
#         --num_train_steps 8000 --warmup_steps 1000 --valid_steps 1000 \
#         --output_dir /data7/emobert/exp/pretrain/resnet3d_nomask_movies_v1v2v3_uniter_mlmitm_lr5e5-backbone_pretrained_optimTrue_lr5e4-bs480_faceth0.5 
