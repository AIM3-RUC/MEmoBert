...
#                 --output_dir /data7/emobert/exp/evaluation/MELD/finetune/resnet3d_baseon-movies_v1v2v3_uniter_4tasks_backbone_scratch_optimFalse-lr${lr}_infbs1_th${conf_th}_max36_train3000
#         done    
# done
...
do
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
                ...
                --cvNo 1 --model_config config/uniter-base-backbone_3dresnet.json \
                --config config/train-emo-${corpus_name}-openface-base-2gpu.json \
                --checkpoint /data7/emobert/exp/task_pretrain/meld_basedon-resnet3d_nomask_movies_v1v2v3_uniter_2tasks_faceth0.5-2tasks_maxbb36_faceth0.5/1/ckpt/model_step_1500.pt \
                --frozen_en_layers ${frozens} --cls_dropout ${dropout} --cls_type emocls --postfix none \
                --learning_rate ${lr} --lr_sched_type 'linear' --conf_th ${conf_th} --max_bb 36 \
                --train_batch_size 32 --inf_batch_size 1 --num_train_steps 3000 --valid_steps 300  \
                --output_dir /data7/emobert/exp/evaluation/MELD/finetune/resnet3d_taskpretrain-baseon-movies_v1v2v3_uniter_2tasks_backbone_optimTure_1e3-lr${lr}_infbs1_th${conf_th}_max36_train3000
        done    
done