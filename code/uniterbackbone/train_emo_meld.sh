...
do
        ...
        CUDA_VISIBLE_DEVICES=${gpu_id} horovodrun -np 1 python train_emo.py \
                ...
                --output_dir /data7/emobert/exp/evaluation/MELD/finetune/resnet3d_baseon-movies_v1v2v3_uniter_4tasks_backbone_scratch_optimFalse-lr${lr}_bs32_th${conf_th}_train3000
        done    
done