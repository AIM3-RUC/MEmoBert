...
#                 --ft_name nomask_movies_v1v2v3_uniter3m_speechwav2vec_5taskswwm_mrm_msrm_maskprobv.5s.5_noitm_lr5e5_bs800_nofinetune_onlyT \
...
#                 --a_ft_type '' --a_input_size 768 --max_acoustic_tokens 64 \
#                 --l_ft_type ''  --l_input_size 768 --max_text_tokens 50 \
#                 --ft_name nomask_movies_v1v2v3_uniter3m_speechwav2vec_5taskswwm_mrm_msrm_maskprobv.5s.5_noitm_lr5e5_bs800_nofinetune_onlyV \
#                 --l_hidden_size 256 --v_hidden_size 256 --a_hidden_size 256 --mid_fusion_layers '256,128'
#         done
#     done
# done
...
#                 --a_ft_type '' --a_input_size 768 --max_acoustic_tokens 64 \
#                 --l_ft_type ''  --l_input_size 768 --max_text_tokens 50 \
#                 --ft_name nomask_movies_v1v2v3_uniter3m_speechwav2vec_5taskswwm_mrm_msrm_maskprobv.5s.5_noitm_lr5e5_bs800_nofinetune_onlyS \
#                 --l_hidden_size 256 --v_hidden_size 256 --a_hidden_size 256 --mid_fusion_layers '256,128'
#         done
#     done
# done
...
#                 --a_ft_type '' --a_input_size 768 --max_acoustic_tokens 64 \
#                 --l_ft_type '' --l_input_size 768 --max_text_tokens 50 \
#                 --ft_name nomask_movies_v1v2v3_uniter3m_speechwav2vec_5taskswwm_mrm_msrm_maskprobv.5s.5_noitm_lr5e5_bs800_nofinetune_onlyVS \
