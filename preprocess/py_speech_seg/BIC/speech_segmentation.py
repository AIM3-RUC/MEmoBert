...
def multi_segmentation(file, sr, frame_size, frame_shift, plot_seg=False, save_seg=False, save_dir=None, cluster_method=None):
    ...
    if save_seg:
        ...
        for i in range(len(save_segpoint)-1):
            ...
            sf.write(f"{save_dir}/{i}.wav", tempAudio, sr)
